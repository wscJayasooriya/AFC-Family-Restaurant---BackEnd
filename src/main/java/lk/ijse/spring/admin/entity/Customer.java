...
public class Customer {
    ...
    public Customer(String cus_Name, String cus_UName, String cus_Address, String cus_Email, String cus_Contact, String cus_Password, String cus_ConfPassword) {
    ...
    public Customer(String cus_UName, String cus_Password) {
